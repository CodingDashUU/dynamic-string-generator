...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/character-set': RouteRecordInfo<
      ...
      | never
    >,
    '/dynamic-generator-page': RouteRecordInfo<
      '/dynamic-generator-page',
      '/dynamic-generator-page',
      Record<never, never>,
      Record<never, never>,
      | never
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/character-set.vue': {
      routes:
        | '/character-set'
      views:
        | never
    }
    'src/pages/dynamic-generator-page.vue': {
      routes:
        | '/dynamic-generator-page'
      views:
        | never
